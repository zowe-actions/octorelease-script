  ...
  "node_modules/@octorelease/core/lib/inputs.js"(exports) {
    ...
    var Inputs = class {
      static get configDir() {
        const input = core2.getInput("config-dir");
        return input ? path2.resolve(this.rootDir, input) : void 0;
      }
      static get dryRun() {
        try {
          return core2.getBooleanInput("dry-run");
        } catch (error2) {
      ...
      static get newVersion() {
        return core2.getInput("new-version") || void 0;
      }
      static get skipStages() {
        const input = core2.getInput("skip-stages");
        return input ? input.split(",").map((s) => s.trim()) : [];
      }
      static get workingDir() {
        return core2.getInput("working-dir") || void 0;
      }
    };
...
var require_teamcity = __commonJS({
  "node_modules/env-ci/services/teamcity.js"(exports, module2) {
    ...
    var getProperties = ({ env, cwd }) => {
      ...
      return fromEntries(Object.keys(PROPERTIES_MAPPING).map((key) => [
        key,
...
function run() {
  return __async(this, null, function* () {
    try {
      ...
      const context = yield import_core.utils.buildContext();
      if (context == null) {
        core.info("Current branch is not a release branch, exiting now");
        process.exit();
      }
      const script = yield import(path.join(__dirname, core.getInput("script")));
      yield script(context);
    } catch (error2) {
