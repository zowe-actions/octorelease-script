...
// node_modules/@octorelease/git/lib/utils.js
var require_utils = __commonJS({
  "node_modules/@octorelease/git/lib/utils.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function gitConfig(context) {
      return __awaiter(this, void 0, void 0, function* () {
        yield exec3.exec("git", ["config", "--global", "user.name", context.env.GIT_COMMITTER_NAME]);
        yield exec3.exec("git", ["config", "--global", "user.email", context.env.GIT_COMMITTER_EMAIL]);
        if (context.env.GIT_CREDENTIALS != null) {
          ...
          fs3.appendFileSync(path2.join(os2.homedir(), ".git-credentials"), `${gitUrl.protocol}//${context.env.GIT_CREDENTIALS}@${gitUrl.host}`);
        }
      });
    }
...
// node_modules/@octorelease/git/lib/init.js
var require_init = __commonJS({
  "node_modules/@octorelease/git/lib/init.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
...
// node_modules/@octorelease/git/lib/version.js
var require_version = __commonJS({
  "node_modules/@octorelease/git/lib/version.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    function default_1(context, config) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield utils.gitCommit(commitMessage.replace("{{version}}", context.version.new)))) {
          context.logger.warning("Nothing to commit");
        }
        tagMessage = tagMessage === null || tagMessage === void 0 ? void 0 : tagMessage.replace("{{version}}", context.version.new);
        if (!(yield utils.gitTag(context.tagPrefix + context.version.new, tagMessage))) {
          context.logger.warning("Git tag already exists");
        }
        if (!(yield utils.gitPush(context, context.branch.name, true))) {
...
// node_modules/@octorelease/git/lib/config.js
var require_config = __commonJS({
  "node_modules/@octorelease/git/lib/config.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/@octorelease/git/lib/index.js
var require_lib = __commonJS({
  "node_modules/@octorelease/git/lib/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
  ...
  "node_modules/tmp/lib/tmp.js"(exports, module2) {
    ...
    function _assertIsRelative(name, option, tmpDir) {
      if (option === "name") {
        ...
        let basename2 = path2.basename(name);
...
module.exports = __toCommonJS(npmUpdate_exports);
var fs2 = __toESM(require("fs"));
var exec = __toESM(require_exec());
var import_git = __toESM(require_lib());
...
function getArtifactName(defaultName) {
...
function writeArtifactJson(name, value) {
  return __async(this, null, function* () {
...
function npmUpdate_default(context) {
  return __async(this, null, function* () {
    const branchConfig = context.branch;
    ...
    context.logger.info(`Checking for updates to ${pluralize("dependency", Object.keys(dependencies).length, true)} and ${pluralize("dev dependency", Object.keys(devDependencies).length, true)}`);
    const artifactName = getArtifactName("resolutions");
    const resolutionsCached = yield readArtifactJson(artifactName);
